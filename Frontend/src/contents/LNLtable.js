...
const LNLtable = () => {
  ...
  const defaultColumnDefs = [
    ...allColumns.commonColumns,
    ...allColumns.timingDataColumnDefs,
    ...allColumns.routingDataColumnDefs,
    ...allColumns.designDataColumnDefs,
    ...allColumns.powerDataColumnDefs,
    ...allColumns.computeDataColumnsDefs,
  ];
  ...
  const getCategoryColumnDefs = () => {
    switch (selectedCategory) {
      ...
      case "timingData":
        return allColumns.timingDataColumnDefs;
      case "routingData":
        return allColumns.routingDataColumnDefs;
      case "powerData":
        return allColumns.powerDataColumnDefs;
      case "designData":
        return allColumns.designDataColumnDefs;
      case "caliberSummaryData":
        return allColumns.CaliberSummaryDataColumnDefs;
      case "computeData":
        return allColumns.computeDataColumnsDefs;
